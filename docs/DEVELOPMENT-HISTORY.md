# ELITE: NEXT — development history

> Moved from the root `README.md` so the GitHub front page can stay player-facing.
> For downloads, use **[Releases](https://github.com/roodmilk/elite-next-psp/releases/latest)**.
> Canonical short notes: [`CHANGELOG.md`](../CHANGELOG.md). Current handoff: [`CLAUDE-HANDOFF.md`](../CLAUDE-HANDOFF.md).

# Development build 2.5.2 (archive entry)
