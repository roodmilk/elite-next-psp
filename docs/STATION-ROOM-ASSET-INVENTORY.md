...
| Canteen / Bar | Art 1 | Native family proofs: Reorte H0 `second-shift-native-v2`, Qube H0 `qube-freight-canteen-v1`, Xequerin H0 `xequerin-research-canteen-v1`; Lysa/Pell/Dax plus family-specific painted occupants | Deterministic dispatch is wired for system 39/H0, 1/H0 and 4/H0; the right-hand station directory and existing interaction rules remain runtime-owned | 480×272 native reviews and 340×168 packed payloads build successfully; combined emulator capture pending | Native talk/job/free-practice states; high contrast; closed/pre-kit/full-capacity states; final combined perf; expand selectors only after QA approval |
...
- Keep Reorte H0 Arrivals, Reorte H0 Second Shift, Qube H0 Freight and Xequerin H0 Research as bounded authored exceptions; generic fallback remains correct elsewhere.
