 ...
 * answers the commander's ask on beat N. Feature screenplay authority:
...
static const SagaBeat saga_beats[]={
 /* Beat0 hook → ask0 → Beat1 answers ask0 → … → Beat5 objective → accept. */
 {"Something Worth Carrying","KEI",
  ...
  "Who is she holding it for?","Why would Ryn miss three calls?","Should I open the case in flight?","What about the hazard notice?","Sealed and straight home. Understood.","Accept the delivery run.",
 ...
 {"The Quiet Between Pings","ORU",
  ...
  "What am I listening for?","So I should not shoot at all?","What if I scare them off?","Where do I take the scan?","Quiet approach. No weapons.","Begin the quiet scan.",
 ...
 {"All Hands Accounted For","TAMSIN",
  ...
  "Which convoy are we talking about?","You need the last port stamp?","Who moved the route on you?","Should I look for pods too?","I will get the stamp.","Accept the search.",
 ...
 {"A Lawful Mistake","IONA",
  ...
  "How can theft predate the cargo?","Will you stand with me on this?","Inspection or pay under protest?","What exactly do you need?","I will keep the records clean.","Return the records to Iona.",
 ...
 {"The Last Useful Thing","NADI",
  ...
  "Is the wreck still intact?","What did Pip find in there?","What is on the recorder?","Should I take scrap too?","Dump and pull clear. Got it.","Begin the wreck scan.",
 ...
 {"The Price of Silence","SABLE",
  ...
  "What are you offering me?","What are my real options?","Who actually wants this ledger?","And if I refuse your deal?","I understand the cost.","Make the custody choice.",
 ...
 {"No Cargo Is Just Cargo","MARA",
  ...
  "Who is stranded out there?","How do I get them power?","Does the method matter?","What do they need first?","I will open that dock.","Set course for the settlement.",
 ...
 {"Ghosts of GalCop","VENN",
  ...
  "What did the seal used to mean?","Why did GalCop fail, then?","What should I listen for?","Is this just nostalgia?","I will walk the chain.","Begin the beacon survey.",
 ...
 {"The Mycoid Ledger","IONA",
  ...
  "What is actually in the ledger?","Why does Meridian want it?","We will not weaponise this?","Who should be allowed to read it?","I will secure it intact.","Accept the archive run.",
 ...
 {"Where the Giants Turn","ORU",
  ...
  "Why cut the engines?","What am I matching out there?","She wrote in their calls?","How do I avoid scaring them?","Observe only. No force.","Begin the quiet survey.",
 ...
 {"The Person on the Other End","RYN",
  ...
  "You are really alive?","How rough are those coords?","Kei has been looking for you.","What do I shut down there?","I am on my way.","Accept the shelter run.",
 ...
 {"What We Carry Home","KEI",
  ...
  "She is really safe?","What if we publish now?","What if we verify first?","What is the limited alert?","I understand the stakes.","Make the publication choice.",
 ...
 {"A Map for Everyone","RYN",
  ...
  "Who wants this map?","Neutral archive — what does that mean?","What about a Meridian buyout?","So I refuse exclusives?","I will deliver the packets.","Accept the archive run.",
 ...
 {"Federal Measure","TAMSIN",
  ...
  "What are they offering?","What is the catch in the fine print?","Will they show a rescue?","Should I refuse them today?","I will listen carefully.","Meet the Federal envoy.",
 ...
 {"Imperial Courtesy","SABLE",
  ...
  "What does their courtesy cost?","Is the funding real?","Who should I watch?","We are not signing today?","I will hear them out.","Meet the Imperial envoy.",
 ...
 {"Alliance of Necessity","IONA",
  ...
  "What do they actually offer?","Why prefer witnesses to certainty?","Will you test their trail?","What should I ask them?","I will hear their case.","Meet the Alliance envoy.",
 ...
 {"The Coldest Signal","PIP",
  ...
  "Nonhuman — how sure are you?","So no weapons at all?","Will it look like a target?","What do I bring back?","Record and withdraw.","Begin the silent scan.",
 ...
 {"No Easy Flag","RYN",
  ...
  "Allies or owners — meaning?","What does a coalition actually do?","What does prior trust buy?","Can we finish without killing?","I understand the choice.","Choose the coalition.",
 ...
 {"The Black Flight","VENN",
  ...
  "Who crossed the public lane?","How do you want it broken?","Lives over wreckage — confirmed?","What if I fail out there?","I will clear the lane.","Engage the blockade.",
 ...
 {"Aegis Echo","ORU",
  ...
  "What did Aegis learn the hard way?","Why share the science?","What does the buoy unlock?","How do I avoid a fight?","I will recover it intact.","Begin the buoy recovery.",
 ...
 {"The Open Channel","KEI",
  ...
  "Disable — not destroy?","What will Voss claim?","How do we answer him?","What if crews are in the way?","Precision over revenge.","Assault the primary relay.",
 ...
 {"The Answering Dark","RYN",
  ...
  "It answered us?","So we only record?","No pursuit at all?","Oru said making room?","Record and leave.","Begin the echo recording.",
 ...
 {"Who Keeps the Light","IONA",
  ...
  "Why does someone hold the keys?","What are the three options?","Do losers lose access?","What does trust change?","I will choose carefully.","Choose the custodian.",
 ...
 {"A Berth Kept Warm","KEI",
  ...
  "Berth six is permanent?","You are giving me a home?","Does free flight still stay?","Will you stay on channel?","I will come home to Lave.","Return to Lave Hub.",
...
static void saga_begin(Game *g){
 ...
 message(g,b->objective);speak(g,saga_voice_who(b),b->talk6);
