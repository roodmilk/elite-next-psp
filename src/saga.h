...
static const SagaBeat saga_beats[]={
 ...
 {"Something Worth Carrying","KEI",
  ...
  "She is holding it for you, if you are willing to make the trip. I could not leave Lave while other survey crews needed someone on the channel, so I asked Mara to keep it safe.",
  "Ryn sometimes forgets a meal, but she always checks in after a survey. Missing three calls means something has prevented her from reaching us.",
  "Please leave it sealed. If anyone challenges what we find, an intact seal will help us show that the receiver was not altered during the journey.",
  "The hazard notice was filed eleven minutes before the public bulletin. Check your fuel and follow the plotted route rather than taking an unexplained detour.",
  "Mara needs you to dock at her station so she can record the handover. She will give you the sealed receiver there; you do not need to buy it from the market.",
  "Keep flying if you can get clear safely. Bringing the receiver home matters more than winning a fight, and I am not asking you to take unnecessary risks.",
  "First, dock at Mara's station to collect the receiver. Your destination will then change to Lave. Bring it back sealed and dock here to finish the delivery.",
 ...
 {"What We Carry Home","KEI",
  "Ryn is safe, but her evidence shows how Meridian has been controlling the routes other settlements depend on. We need to decide how to release it.",
  "Yes, Ryn is safe. She is angry about what happened, but she is herself again. We still need to decide how to share the evidence she brought home.",
  "Publishing now lets settlements prepare immediately, but it also tells Meridian what we know. Verifying the evidence first gives us a stronger case, at the cost of time.",
  "If we verify it first, Iona can build a stronger legal case. The drawback is that settlements will have to wait longer for a warning about the routes they depend on.",
  "A limited alert warns pilots about immediate hazards without releasing the whole investigation. People may trust us less if they feel we withheld the truth.",
  "I am asking you because you helped recover this evidence and have seen what the danger means for working pilots. I will explain the options, but I will not choose for you.",
  "Yes. Once we release the information, we cannot take it back. Read the consequences of each option before confirming your choice.",
  "Choose how to release Ryn's evidence using the replies below. Highlight the option you want, read its consequences, and press Cross to confirm.",
  "She is really safe?",
 ...
 {"The Open Channel","KEI",
  "We have reached the relay that controls these routes. The hostile escorts are protecting it, but the working crews nearby are not our enemies.",
  "Our objective is to stop the relay from controlling these routes. Concentrate on the hostile escorts rather than treating everyone in the system as an enemy.",
  "Voss will say his control kept the routes dependable. The records we recovered show what that control cost the people who had no choice but to use them.",
  "We answer him by keeping the evidence available and ending the threat at the relay. Attacking uninvolved crews would only help him justify what he did.",
  "Keep clear of civilian traffic and identify your target before you fire. Those crews did not choose to become part of this fight.",
  "No. I want Voss to be answerable for what he has done. Killing him is not a condition of this assignment.",
  "Yes. Protect working crews by keeping the fight away from them. Our task is to stop the hostile ships defending the relay.",
  "Travel to the relay system and defeat a hostile ship there. Then open Tracked Mission and choose Complete chapter to report the result.",
  "Disable — not destroy?",
 ...
 {"A Berth Kept Warm","KEI",
  ...
  "Yes, the berth is yours to return to. Venn made the arrangement official, even if he would rather call it routine station business than admit he is grateful.",
  "I am offering you a place where people will be glad to see you. It does not mean that you owe us the rest of your life.",
  "Yes. You can keep exploring, trading and taking contracts after this story ends. Returning to Lave does not end free flight.",
  "I will still be here on the channel. You helped bring Ryn home, and I would like to hear where your next journey takes you.",
  "There is no obligation attached to it. Come back because you want to see us, not because you think you need our permission to leave.",
  "Come back whenever you are ready. For this final report, dock at Lave Hub and open Tracked Mission; after that, the next journey is yours to choose.",
  "Return to Lave System Hub and dock. Then open Tracked Mission and choose Complete chapter to finish our story. You can continue flying afterward.",
...
static const char *saga_coda_line1(int chapter){
 static const char *a[]={
  "Venn has placed the sealed receiver in evidence storage. We now have a record of its handover, so nobody can claim we changed it during the journey.",
  ...
  "We have recorded your decision about releasing the evidence. The settlements and the people investigating Meridian will respond to the information we chose to share.",
  ...
  "The relay is no longer holding those routes under Meridian's control. We can now decide what should replace that control, with the evidence available for everyone to examine.",
  ...
  "Berth six is ready for you. Ryn is home, our report is complete, and you are free to choose where you fly next.",
 };
...
static const char *saga_coda_line2(int chapter){
 static const char *b[]={
  "Next, Oru will help us compare its recording with a live signal. Continue to hear the next briefing before choosing a route.",
  ...
  "Thank you for hearing the options before deciding. Continue when you are ready to find out what we need to do next.",
  ...
  "Keep the records intact and avoid starting another fight. Continue to the next briefing when you are ready.",
