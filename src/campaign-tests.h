static void campaign_tests(FILE *f,int *failures){
  ...
  * After V7: campaign(20)+saga(40)+route(4)+pax(16)+travellers(48)+CRC(4)=132. */
 if(n>132){bytes[4]=7;FILE *v7=fopen("test-cp-v7.sav","wb");if(v7){fwrite(bytes,1,n-132,v7);fclose(v7);}}
