...
#define DECK_ITEMS 23
#define DECK_GROUPS 5
static const int deck_rows[DECK_GROUPS][6]={{0,8,11,2,20,-1},{1,3,4,21,-1,-1},{17,12,13,7,-1,-1},{15,14,22,-1,-1,-1},{5,6,16,19,9,-1}};
static const int deck_sizes[]={5,4,4,3,5};
