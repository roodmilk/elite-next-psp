...
static const int deck_rows[DECK_GROUPS][6]={{0,8,11,2,10,20},{1,3,4,21,23,24},{17,12,13,7,18,-1},{15,14,22,-1,-1,-1},{5,6,16,19,9,-1}};
static const int deck_sizes[]={6,6,5,3,5};
...
static int deck_service_visible(int id){if(!tutorial_service(&game,id))return 0;if(id==3||id==4||id==12||id==23||id==24)return game.docked;return 1;}
