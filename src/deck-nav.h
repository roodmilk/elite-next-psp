...
#define DECK_ITEMS 21
#define DECK_GROUPS 5
static const int deck_rows[DECK_GROUPS][6]={{0,8,11,2,20,-1},{1,3,4,-1,-1,-1},{17,12,13,7,14,-1},{15,-1,-1,-1,-1,-1},{5,6,16,19,9,-1}};
static const int deck_sizes[]={5,3,5,1,5};
