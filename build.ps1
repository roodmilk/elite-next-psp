...
Run-Tool 'psp-gcc' (@('-G0',"-L$portSdk/lib","-specs=$portSdk/lib/prxspecs","-Wl,-q,-T$portSdk/lib/linkfile.prx",'-Wl,-zmax-page-size=128') + $portObjects + @("$portSdk/lib/prxexports.o",'-lpspdebug','-lpspdisplay','-lpspge','-lpspgu','-lpspctrl','-lpsppower','-lpsprtc','-lpspaudio','-lpspmp3','-lpsputility','-lpspnet_adhocctl','-lpspnet_adhoc','-lpspnet','-lm','-o',"$portBuild/elite-a.elf"))
Run-Tool 'psp-fixup-imports' @("$portBuild/elite-a.elf")
Run-Tool 'psp-prxgen' @("$portBuild/elite-a.elf","$portBuild/elite-a.prx")
Run-Tool 'mksfoex' @('-d','MEMSIZE=0','ELITE: NEXT 2.5.46',"$portBuild/PARAM.SFO")
