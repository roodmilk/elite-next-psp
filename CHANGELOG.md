...
- **Story tip batch (untagged):** living texture — radio/freight hails echo Open Channel flags; Spacebook Dockhand/Spotters rotate; rare Voss GalNet sightings after Ch.22 (`src/living-texture.h`). No micro-tag.
