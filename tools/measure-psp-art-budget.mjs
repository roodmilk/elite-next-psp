...
const report={
  ...
  selector:{version:'pending',fingerprint_inputs:['galaxy_id','system_id','hub_index','room_code','body_id','selector_version'],offline_parity:'pending',runtime_writes:[]},
  runtime_guardrails:{runtime_allocations:contract.rules.runtime_allocations,collision_from_art:contract.rules.collision_from_art,gameplay_rng:contract.rules.gameplay_rng,max_surface_props:contract.budgets.max_surface_props,max_scannables:contract.budgets.max_scannables,max_dynamic_activity:contract.budgets.max_dynamic_activity,static_asset_bytes:'measured above',plan_bytes:'pending packed descriptor export',peak_temp_memory_bytes:'pending capture',draw_calls_per_frame:'pending capture',frame_time_ms:'pending PSP/emulator capture',draw_cost:'not instrumented; requires PSP/emulator capture before runtime composition expands'}
};
