...
check(stations.records?.every(r=>r.windows>=4&&r.windows<=13&&r.traffic>=2&&r.traffic<=10&&r.security>=1&&r.security<=7&&r.service>=1&&r.service<=5),'station activity bounds invalid');
